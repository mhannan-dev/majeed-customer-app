...
import 'package:fodoq/features/product/controllers/campaign_controller.dart';
import 'package:fodoq/features/cart/controllers/cart_controller.dart';
import 'package:fodoq/features/cart/domain/repositories/cart_repository.dart';
import 'package:fodoq/features/cart/domain/repositories/cart_repository_interface.dart';
import 'package:fodoq/features/cart/domain/services/cart_service.dart';
import 'package:fodoq/features/cart/domain/services/cart_service_interface.dart';
import 'package:fodoq/features/chat/controllers/chat_controller.dart';
import 'package:fodoq/features/chat/domain/repositories/chat_repository.dart';
import 'package:fodoq/features/chat/domain/repositories/chat_repository_interface.dart';
import 'package:fodoq/features/chat/domain/services/chat_service.dart';
import 'package:fodoq/features/chat/domain/services/chat_service_interface.dart';
import 'package:fodoq/features/checkout/controllers/checkout_controller.dart';
import 'package:fodoq/features/checkout/domain/repositories/checkout_repository.dart';
import 'package:fodoq/features/checkout/domain/repositories/checkout_repository_interface.dart';
import 'package:fodoq/features/checkout/domain/services/checkout_service.dart';
import 'package:fodoq/features/checkout/domain/services/checkout_service_interface.dart';
import 'package:fodoq/features/coupon/controllers/coupon_controller.dart';
import 'package:fodoq/features/home/controllers/home_controller.dart';
import 'package:fodoq/features/home/domain/repositories/home_repository.dart';
import 'package:fodoq/features/home/domain/repositories/home_repository_interface.dart';
import 'package:fodoq/features/home/domain/services/home_service.dart';
...
import 'package:fodoq/features/order/domain/repositories/order_repository.dart';
import 'package:fodoq/features/order/domain/repositories/order_repository_interface.dart';
import 'package:fodoq/features/order/domain/services/order_service.dart';
import 'package:fodoq/features/order/domain/services/order_service_interface.dart';
import 'package:fodoq/features/product/domain/repositories/campaign_repository.dart';
import 'package:fodoq/features/product/domain/repositories/campaign_repository_interface.dart';
import 'package:fodoq/features/product/domain/services/campaign_service.dart';
...
import 'package:fodoq/features/html/controllers/html_controller.dart';
import 'package:fodoq/features/html/domain/repositories/html_repository.dart';
import 'package:fodoq/features/html/domain/repositories/html_repository_interface.dart';
import 'package:fodoq/features/html/domain/services/html_service.dart';
import 'package:fodoq/features/html/domain/services/html_service_interface.dart';
import 'package:fodoq/features/language/domain/models/language_model.dart';
import 'package:fodoq/features/language/domain/repository/language_repository.dart';
import 'package:fodoq/features/language/domain/repository/language_repository_interface.dart';
import 'package:fodoq/features/language/domain/service/language_service.dart';
import 'package:fodoq/features/language/domain/service/language_service_interface.dart';
import 'package:fodoq/features/notification/controllers/notification_controller.dart';
import 'package:fodoq/features/notification/domain/repository/notification_repository.dart';
import 'package:fodoq/features/notification/domain/repository/notification_repository_interface.dart';
import 'package:fodoq/features/notification/domain/service/notification_service.dart';
import 'package:fodoq/features/notification/domain/service/notification_service_interface.dart';
import 'package:fodoq/features/onboard/controllers/onboard_controller.dart';
import 'package:fodoq/features/onboard/domain/repository/onboard_repository.dart';
import 'package:fodoq/features/onboard/domain/repository/onboard_repository_interface.dart';
import 'package:fodoq/features/onboard/domain/service/notification_service.dart';
...
import 'package:fodoq/features/profile/domain/repositories/profile_repository.dart';
import 'package:fodoq/features/profile/domain/repositories/profile_repository_interface.dart';
import 'package:fodoq/features/profile/domain/services/profile_service.dart';
import 'package:fodoq/features/profile/domain/services/profile_service_interface.dart';
import 'package:fodoq/features/refer%20and%20earn/controllers/refer_and_earn_controller.dart';
import 'package:fodoq/features/restaurant/domain/repositories/restaurant_repository.dart';
import 'package:fodoq/features/restaurant/domain/repositories/restaurant_repository_interface.dart';
import 'package:fodoq/features/restaurant/domain/services/restaurant_service.dart';
import 'package:fodoq/features/restaurant/domain/services/restaurant_service_interface.dart';
import 'package:fodoq/features/search/controllers/search_controller.dart';
import 'package:fodoq/features/search/domain/repositories/search_repository.dart';
import 'package:fodoq/features/search/domain/repositories/search_repository_interface.dart';
import 'package:fodoq/features/search/domain/services/search_service.dart';
...
import 'package:fodoq/features/splash/controllers/theme_controller.dart';
import 'package:fodoq/api/api_client.dart';
import 'package:fodoq/features/address/controllers/address_controller.dart';
import 'package:fodoq/features/address/domain/reposotories/address_repo.dart';
import 'package:fodoq/features/address/domain/reposotories/address_repo_interface.dart';
import 'package:fodoq/features/address/domain/services/address_service.dart';
import 'package:fodoq/features/address/domain/services/address_service_interface.dart';
import 'package:fodoq/features/auth/controllers/deliveryman_registration_controller.dart';
import 'package:fodoq/features/auth/controllers/restaurant_registration_controller.dart';
import 'package:fodoq/features/auth/domain/reposotories/auth_repo.dart';
import 'package:fodoq/features/auth/domain/reposotories/auth_repo_interface.dart';
import 'package:fodoq/features/auth/domain/reposotories/deliveryman_registration_repo.dart';
import 'package:fodoq/features/auth/domain/reposotories/deliveryman_registration_repo_interface.dart';
import 'package:fodoq/features/auth/domain/reposotories/restaurant_registration_repo.dart';
import 'package:fodoq/features/auth/domain/reposotories/restaurant_registration_repo_interface.dart';
import 'package:fodoq/features/auth/domain/services/auth_service.dart';
import 'package:fodoq/features/auth/domain/services/auth_service_interface.dart';
import 'package:fodoq/features/auth/domain/services/deliveryman_registration_service.dart';
import 'package:fodoq/features/auth/domain/services/deliveryman_registration_service_interface.dart';
import 'package:fodoq/features/auth/domain/services/restaurant_registration_service.dart';
import 'package:fodoq/features/auth/domain/services/restaurant_registration_service_interface.dart';
import 'package:fodoq/features/business/controllers/business_controller.dart';
import 'package:fodoq/features/business/domain/reposotories/business_repo.dart';
import 'package:fodoq/features/business/domain/reposotories/business_repo_interface.dart';
import 'package:fodoq/features/business/domain/services/business_service.dart';
...
import 'package:fodoq/features/category/domain/reposotories/category_repository.dart';
import 'package:fodoq/features/category/domain/reposotories/category_repository_interface.dart';
import 'package:fodoq/features/category/domain/services/category_service.dart';
import 'package:fodoq/features/category/domain/services/category_service_interface.dart';
import 'package:fodoq/features/coupon/domain/reposotories/coupon_repository.dart';
import 'package:fodoq/features/coupon/domain/reposotories/coupon_repository_interface.dart';
import 'package:fodoq/features/coupon/domain/services/coupon_service.dart';
import 'package:fodoq/features/coupon/domain/services/coupon_service_interface.dart';
import 'package:fodoq/features/cuisine/controllers/cuisine_controller.dart';
import 'package:fodoq/features/cuisine/domain/repositories/cuisine_repository.dart';
import 'package:fodoq/features/cuisine/domain/repositories/cuisine_repository_interface.dart';
import 'package:fodoq/features/cuisine/domain/services/cuisine_service.dart';
import 'package:fodoq/features/cuisine/domain/services/cuisine_service_interface.dart';
import 'package:fodoq/features/dashboard/controllers/dashboard_controller.dart';
import 'package:fodoq/features/dashboard/domain/services/dashboard_service.dart';
import 'package:fodoq/features/dashboard/domain/services/dashboard_service_interface.dart';
import 'package:fodoq/features/favourite/controllers/favourite_controller.dart';
import 'package:fodoq/features/favourite/domain/repositories/favourite_repository.dart';
import 'package:fodoq/features/favourite/domain/repositories/favourite_repository_interface.dart';
import 'package:fodoq/features/favourite/domain/services/favourite_service.dart';
import 'package:fodoq/features/favourite/domain/services/favourite_service_interface.dart';
import 'package:fodoq/features/interest/controllers/interest_controller.dart';
import 'package:fodoq/features/interest/domain/repositories/interest_repository.dart';
import 'package:fodoq/features/interest/domain/repositories/interest_repository_interface.dart';
import 'package:fodoq/features/interest/domain/services/interest_service.dart';
...
import 'package:fodoq/features/location/domain/reposotories/location_repo.dart';
import 'package:fodoq/features/location/domain/reposotories/location_repo_interface.dart';
import 'package:fodoq/features/location/domain/services/location_service.dart';
import 'package:fodoq/features/location/domain/services/location_service_interface.dart';
import 'package:fodoq/features/loyalty/controllers/loyalty_controller.dart';
import 'package:fodoq/features/loyalty/domain/repositories/loyalty_repository.dart';
import 'package:fodoq/features/loyalty/domain/repositories/loyalty_repository_interface.dart';
import 'package:fodoq/features/loyalty/domain/services/loyalty_service.dart';
import 'package:fodoq/features/loyalty/domain/services/loyalty_service_interface.dart';
import 'package:fodoq/features/product/controllers/product_controller.dart';
import 'package:fodoq/features/product/domain/repositories/product_repository.dart';
import 'package:fodoq/features/product/domain/repositories/product_repository_interface.dart';
import 'package:fodoq/features/product/domain/services/product_service.dart';
...
import 'package:fodoq/features/review/domain/repositories/review_repository.dart';
import 'package:fodoq/features/review/domain/repositories/review_repository_interface.dart';
import 'package:fodoq/features/review/domain/services/review_service.dart';
import 'package:fodoq/features/review/domain/services/review_service_interface.dart';
import 'package:fodoq/features/splash/domain/repositories/splash_repository.dart';
import 'package:fodoq/features/splash/domain/repositories/splash_repository_interface.dart';
import 'package:fodoq/features/splash/domain/services/splash_service.dart';
import 'package:fodoq/features/splash/domain/services/splash_service_interface.dart';
import 'package:fodoq/features/verification/controllers/verification_controller.dart';
import 'package:fodoq/features/verification/domein/reposotories/verification_repo.dart';
import 'package:fodoq/features/verification/domein/reposotories/verification_repo_interface.dart';
import 'package:fodoq/features/verification/domein/services/verification_service.dart';
import 'package:fodoq/features/verification/domein/services/verification_service_interface.dart';
import 'package:fodoq/features/wallet/controllers/wallet_controller.dart';
import 'package:fodoq/features/wallet/domain/repositories/wallet_repository.dart';
import 'package:fodoq/features/wallet/domain/repositories/wallet_repository_interface.dart';
import 'package:fodoq/features/wallet/domain/services/wallet_service.dart';
