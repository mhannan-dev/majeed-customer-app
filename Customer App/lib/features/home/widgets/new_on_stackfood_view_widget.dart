...
import 'package:fodoq/features/home/widgets/restaurants_card_widget.dart';
...
class NewOnFodoqViewWidget extends StatelessWidget {
  final bool isLatest;
  const NewOnFodoqViewWidget({super.key, required this.isLatest});
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    restController.latestRestaurantList != null
                        ...
                        : const RestaurantsCardShimmer(isNewOnFodoq: false),
                  ],
                ),
              ),
            );
