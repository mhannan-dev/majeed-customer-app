...
import 'package:fodoq_restaurant/features/restaurant/domain/models/variant_type_model.dart';
import 'package:fodoq_restaurant/features/restaurant/domain/models/variation_model.dart';
...
class RestaurantController extends GetxController implements GetxService {
  ...
  Future<void> addProduct(Product product, bool isAdd) async {
    ...
    bool isSuccess = await restaurantServiceInterface.addProduct(
        product, _pickedLogo, isAdd, tags);
    if (isSuccess) {
  ...
  Future<void> getRestaurantReviewList(int? restaurantID) async {
    ...
    List<ReviewModel>? restaurantReviewList =
        await restaurantServiceInterface.getRestaurantReviewList(restaurantID);
