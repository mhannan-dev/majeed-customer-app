...
ThemeData light = ThemeData(
  ...
  primaryColor: const Color(0xFFE2B951),
  ...
  textButtonTheme: TextButtonThemeData(
      style: TextButton.styleFrom(foregroundColor: const Color(0xFFE2B951))),
  colorScheme: const ColorScheme.light(
          primary: Color(0xFFE2B951),
          tertiary: Color(0xff6165D7),
          tertiaryContainer: Color(0xff171DB6),
          secondary: Color(0xFFE2B951))
