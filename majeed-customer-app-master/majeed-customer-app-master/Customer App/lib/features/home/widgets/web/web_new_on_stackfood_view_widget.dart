...
class WebNewOnFodoqViewWidget extends StatelessWidget {
  final bool isLatest;
  const WebNewOnFodoqViewWidget({super.key, required this.isLatest});
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    restController.latestRestaurantList != null
                        ...
                        : const RestaurantsCardShimmer(isNewOnFodoq: true),
                  ],
                ),
              ),
            );
