...
import 'package:fodoq_restaurant/features/addon/controllers/addon_controller.dart';
import 'package:fodoq_restaurant/features/addon/domain/repositories/addon_repository.dart';
import 'package:fodoq_restaurant/features/addon/domain/repositories/addon_repository_interface.dart';
import 'package:fodoq_restaurant/features/addon/domain/services/addon_service.dart';
...
import 'package:fodoq_restaurant/features/auth/controllers/forgot_password_controller.dart';
import 'package:fodoq_restaurant/features/auth/controllers/location_controller.dart';
import 'package:fodoq_restaurant/features/auth/domain/repositories/auth_repository.dart';
import 'package:fodoq_restaurant/features/auth/domain/repositories/auth_repository_interface.dart';
import 'package:fodoq_restaurant/features/auth/domain/repositories/forgot_password_repository.dart';
import 'package:fodoq_restaurant/features/auth/domain/repositories/forgot_password_repository_interface.dart';
import 'package:fodoq_restaurant/features/auth/domain/repositories/location_repository.dart';
import 'package:fodoq_restaurant/features/auth/domain/repositories/location_repository_interface.dart';
import 'package:fodoq_restaurant/features/auth/domain/services/auth_service.dart';
import 'package:fodoq_restaurant/features/auth/domain/services/auth_service_interface.dart';
import 'package:fodoq_restaurant/features/auth/domain/services/forgot_password_service.dart';
import 'package:fodoq_restaurant/features/auth/domain/services/forgot_password_service_interface.dart';
import 'package:fodoq_restaurant/features/auth/domain/services/location_service.dart';
import 'package:fodoq_restaurant/features/auth/domain/services/location_service_interface.dart';
import 'package:fodoq_restaurant/features/business/controllers/business_controller.dart';
import 'package:fodoq_restaurant/features/business/domain/repositories/business_repository.dart';
import 'package:fodoq_restaurant/features/business/domain/repositories/business_repository_interface.dart';
import 'package:fodoq_restaurant/features/business/domain/services/business_service.dart';
import 'package:fodoq_restaurant/features/business/domain/services/business_service_interface.dart';
import 'package:fodoq_restaurant/features/campaign/controllers/campaign_controller.dart';
import 'package:fodoq_restaurant/features/campaign/domain/repositories/campaign_repository.dart';
import 'package:fodoq_restaurant/features/campaign/domain/repositories/campaign_repository_interface.dart';
import 'package:fodoq_restaurant/features/campaign/domain/services/campaign_service.dart';
import 'package:fodoq_restaurant/features/campaign/domain/services/campaign_service_interface.dart';
import 'package:fodoq_restaurant/features/category/controllers/category_controller.dart';
import 'package:fodoq_restaurant/features/category/domain/repositories/category_repository.dart';
import 'package:fodoq_restaurant/features/category/domain/repositories/category_repository_interface.dart';
import 'package:fodoq_restaurant/features/category/domain/services/category_service.dart';
import 'package:fodoq_restaurant/features/category/domain/services/categoty_service_interface.dart';
import 'package:fodoq_restaurant/features/chat/controllers/chat_controller.dart';
import 'package:fodoq_restaurant/features/chat/domain/repositories/chat_repository.dart';
import 'package:fodoq_restaurant/features/chat/domain/repositories/chat_repository_interface.dart';
import 'package:fodoq_restaurant/features/chat/domain/services/chat_service.dart';
import 'package:fodoq_restaurant/features/chat/domain/services/chat_service_interface.dart';
import 'package:fodoq_restaurant/features/coupon/controllers/coupon_controller.dart';
import 'package:fodoq_restaurant/features/coupon/domain/repositories/coupon_repository.dart';
import 'package:fodoq_restaurant/features/coupon/domain/repositories/coupon_repository_interface.dart';
import 'package:fodoq_restaurant/features/coupon/domain/services/coupon_service.dart';
...
import 'package:fodoq_restaurant/features/deliveryman/domain/repositories/deliveryman_repository.dart';
import 'package:fodoq_restaurant/features/deliveryman/domain/repositories/deliveryman_repository_interface.dart';
import 'package:fodoq_restaurant/features/deliveryman/domain/services/deliveryman_service.dart';
import 'package:fodoq_restaurant/features/deliveryman/domain/services/deliveryman_service_interface.dart';
import 'package:fodoq_restaurant/features/disbursement/controllers/disbursement_controller.dart';
import 'package:fodoq_restaurant/features/disbursement/domain/repositories/disbursement_repository.dart';
import 'package:fodoq_restaurant/features/disbursement/domain/repositories/disbursement_repository_interface.dart';
import 'package:fodoq_restaurant/features/disbursement/domain/services/disbursement_service.dart';
import 'package:fodoq_restaurant/features/disbursement/domain/services/disbursement_service_interface.dart';
import 'package:fodoq_restaurant/features/expense/controllers/expense_controller.dart';
import 'package:fodoq_restaurant/features/expense/domain/repositories/expense_repository.dart';
import 'package:fodoq_restaurant/features/expense/domain/repositories/expense_repository_interface.dart';
import 'package:fodoq_restaurant/features/expense/domain/services/expense_service.dart';
import 'package:fodoq_restaurant/features/expense/domain/services/expense_service_interface.dart';
import 'package:fodoq_restaurant/features/language/controllers/localization_controller.dart';
import 'package:fodoq_restaurant/features/language/domain/repositories/language_repository.dart';
import 'package:fodoq_restaurant/features/language/domain/repositories/language_repository_interface.dart';
import 'package:fodoq_restaurant/features/language/domain/services/language_service.dart';
import 'package:fodoq_restaurant/features/language/domain/services/language_service_interface.dart';
import 'package:fodoq_restaurant/features/notification/controllers/notification_controller.dart';
import 'package:fodoq_restaurant/features/notification/domain/repositories/notification_repository.dart';
import 'package:fodoq_restaurant/features/notification/domain/repositories/notification_repository_interface.dart';
import 'package:fodoq_restaurant/features/notification/domain/services/notification_service.dart';
...
import 'package:fodoq_restaurant/features/order/domain/repositories/order_repository.dart';
import 'package:fodoq_restaurant/features/order/domain/repositories/order_repository_interface.dart';
import 'package:fodoq_restaurant/features/order/domain/services/order_service.dart';
...
import 'package:fodoq_restaurant/features/payment/domain/repositories/payment_repository.dart';
import 'package:fodoq_restaurant/features/payment/domain/repositories/payment_repository_interface.dart';
import 'package:fodoq_restaurant/features/payment/domain/services/payment_service.dart';
...
import 'package:fodoq_restaurant/features/pos/domain/repositories/pos_repository.dart';
import 'package:fodoq_restaurant/features/pos/domain/repositories/pos_repository_interface.dart';
import 'package:fodoq_restaurant/features/pos/domain/services/pos_service.dart';
...
import 'package:fodoq_restaurant/features/profile/domain/repositories/profile_repository.dart';
import 'package:fodoq_restaurant/features/profile/domain/repositories/profile_repository_interface.dart';
import 'package:fodoq_restaurant/features/profile/domain/services/profile_service.dart';
...
import 'package:fodoq_restaurant/features/reports/domain/repositories/report_repository.dart';
import 'package:fodoq_restaurant/features/reports/domain/repositories/report_repository_interface.dart';
import 'package:fodoq_restaurant/features/reports/domain/services/report_service.dart';
...
import 'package:fodoq_restaurant/features/restaurant/domain/repositories/restaurant_repository.dart';
import 'package:fodoq_restaurant/features/restaurant/domain/repositories/restaurant_repository_interface.dart';
import 'package:fodoq_restaurant/features/restaurant/domain/services/restaurant_service.dart';
...
import 'package:fodoq_restaurant/features/splash/domain/repositories/splash_repository.dart';
import 'package:fodoq_restaurant/features/splash/domain/repositories/splash_repository_service.dart';
import 'package:fodoq_restaurant/features/splash/domain/services/splash_service.dart';
import 'package:fodoq_restaurant/features/splash/domain/services/splash_service_interface.dart';
import 'package:fodoq_restaurant/features/subscription/controllers/subscription_controller.dart';
import 'package:fodoq_restaurant/features/subscription/domain/repositories/subscription_repository.dart';
import 'package:fodoq_restaurant/features/subscription/domain/repositories/subscription_repository_interface.dart';
import 'package:fodoq_restaurant/features/subscription/domain/services/subscription_service.dart';
import 'package:fodoq_restaurant/features/subscription/domain/services/subscription_service_interface.dart';
