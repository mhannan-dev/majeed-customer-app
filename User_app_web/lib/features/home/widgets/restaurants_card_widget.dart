import 'package:fodoq/common/widgets/custom_ink_well_widget.dart';
import 'package:fodoq/features/home/widgets/icon_with_text_row_widget.dart';
import 'package:fodoq/features/home/widgets/overflow_container_widget.dart';
...
import 'package:fodoq/common/widgets/not_available_widget.dart';
...
class RestaurantsCardWidget extends StatelessWidget {
  ...
  final bool? isNewOnFodoq;
  const RestaurantsCardWidget(
      {super.key, this.isNewOnFodoq, required this.restaurant});
                  ...
                  Stack(
                    children: [
                      Container(
                        ...
                        height: isNewOnFodoq! ? 98 : 78,
                        width: isNewOnFodoq! ? 98 : 78,
                        decoration: BoxDecoration(
                          color: Theme.of(context).cardColor,
                          borderRadius:
...
class RestaurantsCardShimmer extends StatelessWidget {
  final bool? isNewOnFodoq;
  const RestaurantsCardShimmer({super.key, this.isNewOnFodoq});
